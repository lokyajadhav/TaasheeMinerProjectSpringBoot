...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <form action="assignCourse" method="post" class="mx-auto p-5 mx-auto mt-5 shadow-sm p-3 mb-5 bg-body-tertiary rounded" style="width: 600px">
   <sec:authorize access="hasRole('ADMIN')">
  <div class="mb-3">
    ...
    <option disabled selected>Choose a Course Id to Assign to Instructor</option>
...
<!--     <input type="text" class="form-control" id="exampleInputEmail1" name="cid" >
 -->   
   ...
   <div class="mb-3">
    ...
    <option disabled selected>Choose a Instructor Id to Assign the Course</option>
...
<!--     <input type="text" name="id" class="form-control" id="exampleInputPassword1" >
 -->  </div>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Course Id</label>
    <select name="cid"  class="form-select" aria-label="Default select example">
    <option disabled selected>Choose a Course Id to Assign to Student</option>
    <c:forEach var="course" items="${instructorCourseList}">
    	<option value="${course.id }">${course.id} </option>
    </c:forEach>
    </select>
    <!-- <input type="text" class="form-control" id="exampleInputEmail1" name="cid" >-->
  ...
  <div class="mb-3">
    ...
    <label for="exampleInputPassword1" class="form-label">Student Id</label>
   	<select name="id"  class="form-select" aria-label="Default select example">
   	<option disabled selected>Choose a Student Id to Assign the Course</option>
